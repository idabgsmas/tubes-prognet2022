<!-- INI HALAMAN UTAMA UNTUK EDIT DATA TABEL M_IKS_TIPE -->
...
<!-- <div class="nk-fmg-body-content"> -->
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                Form Edit Data Tipe IKS "{{ $data->nama }}"
            </div>
        </div>
    </div>
<!-- </div> -->

<form method="POST" action="/crud2/update2/{{ $data->id }}" enctype="multipart/form-data">
    @csrf   
    <div class="mb-3">
