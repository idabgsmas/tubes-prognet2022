<!-- INI HALAMAN UTAMA UNTUK EDIT DATA TABEL M_PENJAMIN -->
...
<!-- <div class="nk-fmg-body-content"> -->
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                Form Edit Data Penjamin IKS "{{ $data->nama }}"
            </div>
        </div>
    </div>
<!-- </div> -->

<form method="POST" action="/crud3/update3/{{ $data->id }}" enctype="multipart/form-data">
    @csrf   
    <div class="mb-3">
        <input type="hidden" value="$data->id" id="id">
            <label for="kode" class="form-label">Kode</label>
            <input name="kode" type="number" value="{{ $data['kode'] }}" class="form-control" id="kode" aria-describedby="kode">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="prefix_antrean" type="text" value="{{ $data['prefix_antrean'] }}"class="form-control" id="prefix_antrean" aria-describedby="prefix_antrean">
        </div>
