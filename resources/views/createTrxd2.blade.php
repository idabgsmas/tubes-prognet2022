...
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            ...
            <a href="{{ route('trxd2.list') }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-arrow-left"></em> <span>Kembali</span></a>
        </div>
    </div>
</div>
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.success == 1){
                        ...
                        window.location.replace("{{ url('trxd2') }}");
                    }else{
