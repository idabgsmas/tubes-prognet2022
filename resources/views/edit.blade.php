...
<!-- <div class="nk-fmg-body-content"> -->
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                Form Edit Data IKS "{{ $data->nama }}"
            </div>
        </div>
    </div>
<!-- </div> -->

<form method="POST" action="/crud/update/{{ $data->id }}" enctype="multipart/form-data">
    @csrf   
        <div class="mb-3">
        <input type="hidden" value="$data->id" id="id">
            <label for="kode" class="form-label">Kode IKS</label>
            <input name="kode" type="text" value="{{ $data['kode'] }}" class="form-control" id="kode" aria-describedby="kode">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="masa_berlaku_awal" type="date" value="{{ $data['masa_berlaku_awal'] }}" class="form-control" id="masa_berlaku_awal" aria-describedby="masa_berlaku_awal" required>
        </div>
        <div class="mb-3">
            <label for="masa_berlaku_akhir" class="form-label">Masa Berlaku Akhir</label>
            <input name="masa_berlaku_akhir" type="date" value="{{ $data['masa_berlaku_akhir'] }}" class="form-control" id="masa_berlaku_akhir" aria-describedby="masa_berlaku_akhir" required>
        </div>
