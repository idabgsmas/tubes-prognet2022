<!-- INI HALAMAN UTAMA UNTUK CREATE DATA TABEL M_IKS_TIPE -->
...
<!-- <div class="nk-fmg-body-content"> -->
    <div class="nk-fmg-quick-list nk-block">
        <div class="card">
            <div class="card-body">
                Form Input Data Tipe IKS
            </div>
        </div>
    </div>
<!-- </div> -->
<form method="POST" action="/crud2/store2" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="status_aktif" type="text" class="form-control" id="status_aktif" aria-describedby="status_aktif">
        </div>
